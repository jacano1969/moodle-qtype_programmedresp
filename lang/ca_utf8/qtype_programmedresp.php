...
$string['argguidedquiz'] = 'Qüestionari guiat';
...
$string['errorfunctiondifferentnreturns'] = 'Debe haber una descripción por cada valor devuelto (por ejemplo: @return array 2 Desc1 | Desc2)';
...
$string['refresharguments'] = 'Refrescar arguments';
$string['refreshvarsvalues'] = 'Refrescar valors de les variables';
$string['response'] = 'Resposta';
$string['responsedigits'] = 'Dígits de la resposta';
$string['responseformat'] = 'Format de la resposta';
$string['reponseformatsigniticative'] = 'Dígits significatius';
